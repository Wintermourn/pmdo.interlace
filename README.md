# Interlace
Interlace is a helper script library for PMDO, designed to make things just a little bit easier to manage. The library itself and components can be loaded entirely separately, so feel free to download only what you need!

It is recommended to use [EmmyLua](https://github.com/EmmyLua) or another Lua language server.
...
- Tagging: [wiki](../../wiki/Taxon:-Tagging)  [examples](components/taxon/examples/Data/Tags)
